let upstream =
      ...
      , classless-arbitrary =
        ...
        , repo =
            "https://github.com/thought2/purescript-classless-arbitrary.git"
        , version = "v0.1.1"
        }
      , classless-decode-json =
        ...
        , repo =
            "https://github.com/thought2/purescript-classless-decode-json.git"
        , version = "v0.1.1"
        }
      , classless-encode-json =
        ...
        , repo =
            "https://github.com/thought2/purescript-classless-encode-json.git"
        , version = "v0.1.3"
        }
      , classnames =
      ...
      , foreign-readwrite =
        ...
        , repo =
            "https://github.com/artemisSystem/purescript-foreign-readwrite.git"
        , version = "v3.4.0"
        }
      , fork =
        { dependencies = [ "aff" ]
      ...
      , generate-values =
        ...
        , repo =
            "https://github.com/jordanmartinez/purescript-generate-values.git"
        , version = "v1.0.1"
        }
      , generic-router =
        { dependencies =
      ...
      , halogen-bootstrap5 =
        ...
        , repo =
            "https://github.com/tonicebrian/purescript-halogen-bootstrap5.git"
        , version = "v2.1.0"
        }
      , halogen-css =
      ...
      , httpurple-argonaut =
        ...
        , repo =
            "https://github.com/sigma-andex/purescript-httpurple-argonaut.git"
        , version = "v1.0.1"
        }
      , httpurple-yoga-json =
        { dependencies =
        ...
        , repo =
            "https://github.com/sigma-andex/purescript-httpurple-yoga-json.git"
        , version = "v1.0.0"
        }
      , humdrum =
        { dependencies =
      ...
      , js-promise =
        ...
        , repo =
            "https://github.com/purescript-contrib/purescript-js-promise.git"
        , version = "v1.0.0"
        }
      , js-promise-aff =
      ...
      , marionette-commander =
        ...
        , repo =
            "https://github.com/thought2/purescript-marionette-commander.git"
        , version = "v0.1.1"
        }
      ...
      , rationals =
        ...
        , repo =
            "https://github.com/purescript-contrib/purescript-rationals.git"
        , version = "v5.0.1"
        }
      , rdf =
        { dependencies =
      ...
      , school-of-music =
        ...
        , repo =
            "https://github.com/newlandsvalley/purescript-school-of-music.git"
        , version = "v1.3.0"
        }
      , selection-foldable =
        { dependencies =
      ...
      , strictlypositiveint =
        { dependencies = [ "prelude" ]
        , repo =
            "https://github.com/jamieyung/purescript-strictlypositiveint.git"
        , version = "v1.0.1"
        }
      , string-parsers =
        { dependencies =
      ...
      , typelevel-rows =
        { dependencies = [ "prelude" ]
        , repo =
            "https://github.com/jordanmartinez/purescript-typelevel-rows.git"
        , version = "v0.1.0"
        }
      , uint =
        { dependencies =
      ...
      , web-pointerevents =
        ...
        , repo =
            "https://github.com/purescript-web/purescript-web-pointerevents.git"
        , version = "v1.0.0"
        }
      , web-proletarian =
        { dependencies = [ "effect", "prelude" ]
        , repo =
            "https://github.com/rowtype-yoga/purescript-web-proletarian.git"
        , version = "v1.0.0"
        }
      , web-promise =
        { dependencies =
      ...
      , web-resize-observer =
        ...
        , repo =
            "https://github.com/nsaunders/purescript-web-resize-observer.git"
        , version = "v2.0.0"
        }
      , web-router =
        { dependencies =
...
let packages =
        { d3 =
          ...
          , repo = "https://github.com/garganscript/purescript-d3"
          , version = "v0.10.1"
          }
        }
      ⫽ { dom-simple =
      ...
      ⫽ { simplecrypto =
          { dependencies = [ "effect", "maybe", "node-buffer", "prelude" ]
          , repo = "https://github.com/garganscript/purescript-simplecrypto"
          , version = "v1.1.0"
          }
        }
      ⫽ { toestand =
